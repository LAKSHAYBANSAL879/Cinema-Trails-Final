...
const ShowtimeAddForm = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://cinema-trails.onrender.com/api/v1/showTimes/addShowtime', showtime);
      toast.success("Showtime added successfully");
      onClose();
    } catch (error) {
      console.error('Error adding showtime:', error);
      toast.error("Error in adding a new showtime");
    }
  };
