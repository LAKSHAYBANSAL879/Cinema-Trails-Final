...
const MoviesDrama = () => {
    ...
    useEffect(() => {
        axios.get('https://cinema-trails.onrender.com/api/v1/movies/getAllMovies')
            .then(response => {
                // Filter movies to include only those with the genre "Drama"
                const dramaMovies = response.data.filter(movie => movie.genre.includes('Drama'));
    ...
    return (
        <div className="dark:text-white text-black h-full py-8 -z-10 overflow-hidden duration-500 transition-all">
            <div className="container mx-auto px-4 overflow-hidden">
                <div className="flex justify-between items-center">
                    <h2 className="text-2xl font-bold">Stream Drama Movies</h2>
                </div>
                                ...
                                >
                                    <div className="relative w-full h-full my-5 pb-6">
                                        <div
                                            ...
                                            className='bg-black rounded-lg bg-opacity-80 border-black absolute w-full h-full hidden z-10'
                                        >
